...
class User(UserMixin, PaginatedAPIMixin, db.Model):
    ...
    is_active = db.Column(db.Boolean, nullable=False, default=0)
...
class Post(db.Model):
    __searchable__ = ['body']
    id = db.Column(db.Integer, primary_key=True)
    privacy = db.Column(db.Boolean, nullable=False, default=0)
    is_challenge = db.Column(db.Boolean, default=0)
